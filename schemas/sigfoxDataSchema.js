...
const sigfoxDataSchema = new Schema({
  ...
  deviceUID : {type: mongoose.Schema.Types.ObjectId(), ref: 'deviceModel', required = true}, // name of the model we want to reference
...
var sigfoxDataSchema = mongoose.model('sigfox_device', sigfoxDataSchema);
...
module.exports = {
      sigfox_device: sigfoxDeviceSchema
    };
